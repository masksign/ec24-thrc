...
void polyr_shlm(int64_t *r, const int64_t *a, int sh, int64_t m)
{
    int i;
...
void polyr_shrm(int64_t *r, const int64_t *a, int sh, int64_t m)
{
    int i;
...
void polyr_round(int64_t *r, const int64_t *a, int sh, int64_t h, int64_t m)
{
    int i;
